 ...
 * under the License.
 */
package org.incode.eurocommercial.ecpcrm.module.loyaltycards.dom.numerator;
...
@Queries({
        @Query(
                ...
                value = "SELECT "
                        + "FROM org.incode.eurocommercial.ecpcrm.module.loyaltycards.dom.numerator.Numerator "
                        + "WHERE name == :name")
})
@DomainObject(
