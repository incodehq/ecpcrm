...
public class AuthenticationDeviceFixture extends FixtureScript {
    public AuthenticationDeviceFixture() {
    ...
    protected void execute(final ExecutionContext ec) {
        ...
        for (Center center : centerRepository.listAll()) {
            AuthenticationDeviceCreate authenticationDeviceCreateFixture = new AuthenticationDeviceCreate()
                    .center(center);
            ec.executeChild(AuthenticationDeviceFixture.this, authenticationDeviceCreateFixture);
        }
