 ...
 */
package org.incode.eurocommercial.ecpcrm.module.application.service.activity;
...
public class RecentActivityContributions extends AbstractService {
    ...
    @Inject private CommandServiceJdoRepository commandServiceRepository;
    @Inject private AuditingServiceRepository auditingServiceRepository;
    @Inject private PublishedEventRepository publishedEventRepository;
