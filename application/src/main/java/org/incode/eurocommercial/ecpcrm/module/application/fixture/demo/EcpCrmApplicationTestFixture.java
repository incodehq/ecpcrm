...
public class EcpCrmApplicationTestFixture extends FixtureScript {
    public EcpCrmApplicationTestFixture() {
        ...
        sudoService.sudo(EcpCrmAdminUser.USER_NAME, Arrays.asList(EcpCrmRegularRoleAndPermissions.ROLE_NAME, EcpCrmFixtureServiceRoleAndPermissions.ROLE_NAME),
                new Runnable() {
                    @Override public void run() {
                        ec.executeChild(EcpCrmApplicationTestFixture.this, new LoyaltyCardsIntegTestFixture());
                        ec.executeChild(EcpCrmApplicationTestFixture.this, new AuthenticationDeviceFixture());

                        final MaryHostessUser maryScript = new MaryHostessUser();
                        ec.executeChild(EcpCrmApplicationTestFixture.this, maryScript);
