 ...
 *  under the License.
 */
package org.incode.eurocommercial.ecpcrm.module.application.fixture;
...
public class EcpCrmFixtureScriptsSpecificationProvider implements FixtureScriptsSpecificationProvider {
    ...
    public FixtureScriptsSpecification getSpecification() {
        return FixtureScriptsSpecification
                ...
                .withRunScriptDefault(LoyaltyCardsIntegTestFixture.class)
                .withRunScriptDropDown(FixtureScriptsSpecification.DropDownPolicy.CHOICES)
                .withRecreate(LoyaltyCardsIntegTestFixture.class)
                .build();
    }
}
